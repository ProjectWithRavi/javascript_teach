...
// in switch case default behaviour like else statement
...
// **************************************** we can also switch case with curler bracket
// switch (true) {
//   case userAge >= 0 && userAge <= 4: {
//     console.log(`${username} is a kid.`);
//     break;
...
// in if else statement found false then not run , but in switch case compare which value is false
